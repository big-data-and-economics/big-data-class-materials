...
pacman::p_load(mfx, tidyverse, hrbrthemes, estimatr, ivreg, fixest, sandwich, 
               lmtest, margins, vtable, broom, modelsummary,rstanarm,tidycensus,tigris)
...
if (!require("pacman")) install.packages("pacman")
pacman::p_load(mfx, tidyverse, hrbrthemes, estimatr, ivreg, fixest, sandwich, 
               lmtest, margins, vtable, broom, modelsummary,rstanarm,tigris,kableExtra)
## My preferred ggplot2 plotting theme (optional)
theme_set(theme_minimal())
```
...
```{r opp_atlas}
opp_atlas <- read_csv("opp_atlas_amended.csv") 
