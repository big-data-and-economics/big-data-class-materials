...
- Participate using GitHub Codespace or syncing a fork on your local computer
...
- E.g. The **lubridate** package for working with dates, **rvest** package for webscraping, **broom** to `tidy()` R objects into tables
...
- E.g. `starwars %>% filter(gender=="female") %>% pull(height)` returns a `height` as a vector
