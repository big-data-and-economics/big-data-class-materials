...
- Your data description is due after break
...
- Problem Set 3 will involve using the Census Tract data to learn about income mobility in Lewiston
...
- Spatial analysis (this week)

- Regression analysis (after break)
