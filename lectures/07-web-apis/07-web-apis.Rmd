...
author:
  name: Kyle Coombs
  affiliation: "Bates College | [EC/DCS 368](https://github.com/big-data-and-economics)" #"`r format(Sys.time(), '%d %B %Y')`"
...
```{r census_dictionary, echo=FALSE, out.width="100%", message=FALSE, warning=FALSE}
knitr::include_graphics('pics/census_acs5_2017_dictionary.png')
```
