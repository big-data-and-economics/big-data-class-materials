...
- Lewiston's Department of Economic Development has been in touch about the hack-a-thon

- We'll be helping the city with a project to understand where to put street lights to help reduce crime

- Two options for scheduling hack-a-thon

  - Last week of class - kick off Tuesday (4/9), team presentations Thursday (4/11), participation optional

  - Last two weeks of class - kick off Tuesday (4/2), team presentations Thursday (4/11) and converted to your last problem set, so no longer optional

- I'll poll Thursday to see what works best for everyone
