...
2. Learn the steps of a basic Git/GitHub workflow with Rstudio
  - Create an SSH Key in RStudio if you did not complete the first exercise.
...
☑ Installed [Git](https://git-scm.com/downloads) and [GitHub Desktop](https://desktop.github.com/).

☑ Created an account on [GitHub](https://github.com/) 

☑ Accepted an invitation to ECON 368 course repo.

☑ Created an SSH key in RStudio and added it to your GitHub account.
...
2. Copy the SSH link (the green "Code" button).<sup>1</sup>
3. Open up RStudio.
...
.footnote[<sup>1</sup> Do not use the HTTPS link. It will cause problems with RStudio and you will only be able to use GitHub Desktop.]
