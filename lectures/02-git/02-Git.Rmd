...
☑ Accepted an invitation to ECON 368 course repo (semester specific).
...
---
# First create an SSH-key (the easy way)
...
.footnote[<sup>2</sup> You can actually have branches of branches (of branches). But let's not get ahead of ourselves.]
