...
- Essentially, this defauls to a fast-forward merge, which is what you want in most cases.

- Fast-forward literally brings your local repo up-to-date first, then 
