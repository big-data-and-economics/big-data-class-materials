...
- The [final project replication](https://github.com/big-data-and-economics/final-project) instructions have been posted. Please read through. 
  - Replication proposal is due 1/25
  - It is a group project, please select a partner by 1/18

- I added my policy on posting to GitHub to the [Discussions page](https://github.com/orgs/big-data-and-economics/discussions/6)
  - tl;dr: Post thoughtfully

- How are folks doing with problem set 0?
...
- I host all of the code and data for my [papers](https://kylecoombs.com/research/) on GH. Same for teaching materials. I even use it to host and maintain my [website](https://github.com/grantmcdermott/grantmcdermott.github.io).
...
Before we get started, you need to create an SSH key on your local machine.
...
---
# Add the SSH-key to ssh-agent, then GitHub
...
- For your purposes, I recommend you enter the following in your terminal:

```bash
git config --config pull.rebase false  # merge
```

- Feel to play with any of them though

- This will change your `.gitconfig` file, which sets the settings of git

- If you want to change any, you can do so in the `.gitconfig` file, which you can access (or delete) using the command
...
Problem Set 0 is due on Thursday.

### Problem Set 1 

This will be posted later this week and is due at the end of the month.
