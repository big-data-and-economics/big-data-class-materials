...
- .hi-slate[Option 2:] .hi-purple[Control] for what makes the treatment and control groups different
--
...
- Last week we also talked about control variables approaches

- We can control for variables that are correlated with both the treatment and the outcome
...
- Effectively, these remove within-group averages from the data

- In the case of Bri and Al, this would be like subtracting their hypothetical average earnings from actual earnings

.pull-left[.center[
.pink[Earn.sub[1,Al]] = .pink[$60K]-.blue[$45K] = .pink[$15K]
<br>.purple[Earn.sub[0,Al]] = .purple[$30K] - .blue[$45K] = .purple[-$15K]
]]
.pull-right[
.pink[Earn.sub[1,Bri]] = .pink[$140K] - .blue[$125K] = .pink[$15K]
<br>.purple[Earn.sub[0,Bri]] = .purple[$110K] - .blue[$125K] = .purple[-$15K]
]

- Then if we subtract Bri's college earnings from Al's, we get $30K -- the actual treatment effect

- Why is that impossible though?

--

- We only have one unit for each person! So let's think what we can do with multiple units
