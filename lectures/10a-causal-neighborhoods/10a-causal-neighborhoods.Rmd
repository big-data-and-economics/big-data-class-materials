...
$$
\begin{aligned}
  \text{Income}_{i} = \sum_{m=0}^{m=30} \beta_{m} I(\text{Age at move}_{i}=m) + \epsilon_{i}
\end{aligned}
$$
...
$$
\begin{aligned}
  \text{Income}_{i} = \sum_{m=0}^{m=30} \beta_{m} I(\text{Age at move}_{i}=m) + (\alpha_f + \nu_{i})
\end{aligned}
$$
...
$$
\begin{aligned}
  \text{Income}_{i} - \bar{\text{Income}}_{i} = \sum_{m=0}^{m=30} \beta_{m} I(\text{Age at move}_{i}=m)-\bar{I(\text{Age at move}_{i}=m)} + \nu_{i}
\end{aligned}
$$
...
- One challenge with fixed effects:
   - Each fixed effect reduces the degrees of freedom in your model
