...
> - Per [Stat 545 course](https://stat545.stat.ubc.ca/notes/notes-a01/): copy the error message, strip out highly specific stuff, surround with quotes and Google it!
...
1. In-class exercises: low-stakes completion exercises

2. Datacamp exercises to really dig into the thornier parts of R/git

3. 5 group problem sets, drop the lowest, grade improvement allowed

4. Coding presentation
