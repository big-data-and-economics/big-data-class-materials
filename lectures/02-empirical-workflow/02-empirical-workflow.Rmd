...
- Below is some code I wrote that is throwing an error
- Try to write a MRE
...
library(ggplot2)
mtcars46carb     = mtcars[mtcars$carb==4 | mtcars$carb==6]
mtcars4carb_mean = mean(mtcars[mtcars$carb==4,'mpg'],na.rm=TRUE)
mtcars6carb_mean = mean(mtcars[mtcars$carb==6,'mpg'],na.rm=TRUE)

ggplot(data=mtcars46carb, aes(x=mpg, y=wt)) +
    geom_point() +
    geom_smooth(method='lm') +
    geom_vline(xintercept=mtcars4carb_mean, color='red') +
    geom_vline(xintercept=mtcars6carb_mean, color='blue') +
    annotate('text', x=mtcars4carb_mean-.25,y=5, label='4-carb mean', color='red', angle=90) +
    annotate('text', x=mtcars6carb_mean-.25,y=5, label='6-carb mean', color='blue', angle=90) +
    labs(title='Mpg vs. weight for 4 and 6 carburetor cars')
